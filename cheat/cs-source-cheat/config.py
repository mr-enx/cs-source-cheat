...
ADDR_VISUAL_NORECOIL_1 = CLIENT_BASE + 0x192D4  # No Camera Shake (Punch angle X)
ADDR_VISUAL_NORECOIL_2 = CLIENT_BASE + 0x192DE  # No Camera Shake (Punch angle Y)
...
# Bunnyhop offsets
OFFSET_FORCEJUMP = 0x3E71E4
OFFSET_LOCALPLAYER_BHOP = 0x3B51C4
OFFSET_FLAGS = 0x350

# No Recoil/RCS offsets
OFFSET_LOCALPLAYER = 0x3FB2F0
OFFSET_PUNCHANGLE = 0xBB0
OFFSET_VIEWANGLES = 0x3FD54C

# No Spread stability (cl_predictweapons patch)
ADDR_PREDICTWEAPONS_PATCH = CLIENT_BASE + 0x1E2858
